...
router.get("/table/:id",validateRestaurantToken,async (req,res)=>{
...
router.post("/table", validateRestaurantToken, body('tableName').not().isEmpty().withMessage('Enter table name!'),
